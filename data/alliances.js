...
const ALLIANCES = {
  ...
  brics: {
    ...
    events: [
      ...
      { y: 2026, e: "India assumes BRICS rotating chairmanship; Turkey — which applied for full BRICS membership in September 2024 but was offered only partner status — reaffirms its bid for full membership amid transatlantic rifts, signalling a potential historic crack in NATO alignment. BRICS fails to issue a joint statement on the 2026 US-Israel-Iran war, exposing deep internal divisions between members. In May, Russian FM Lavrov announces BRICS will not rush further expansion, prioritising consolidation of the existing 11-member bloc over new admissions. The 18th BRICS Summit (September 12–13, 2026) concluded at Bharat Mandapam, New Delhi, under the theme 'Building for Resilience, Innovation, Cooperation and Sustainability.' The New Delhi Declaration was unanimously adopted on September 12, calling for calm in the Middle East, smooth flow of global trade and energy, and expressing opposition to the forced displacement of Palestinians; finance ministers issued a separate statement objecting to unilateral tariffs imposed on BRICS members. On the summit's sidelines, Modi held bilateral meetings with Xi Jinping (Xi's first visit to India since 2014, advancing the India-China diplomatic reset), Putin, and Iran's Pezeshkian. Turkey, Azerbaijan, and Malaysia have formally applied for full membership; no new members were admitted at the 2026 summit, with the bloc consolidating at 11 full members." }
    ]
  },
  quad: {
