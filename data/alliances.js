...
const ALLIANCES = {
  ...
  brics: {
    ...
    events: [
      ...
      { y: 2026, e: "India assumes BRICS rotating chairmanship; Turkey — which applied for full BRICS membership in September 2024 but was offered only partner status — reaffirms its bid for full membership amid transatlantic rifts, signalling a potential historic crack in NATO alignment. BRICS fails to issue a joint statement on the 2026 US-Israel-Iran war, exposing deep internal divisions between members. In May, Russian FM Lavrov announces BRICS will not rush further expansion, prioritising consolidation of the existing 11-member bloc over new admissions. The 18th BRICS Summit opened on September 12, 2026 at Bharat Mandapam, New Delhi, under the theme 'Building for Resilience, Innovation, Cooperation and Sustainability.' The New Delhi Declaration called for calm in the Middle East, smooth flow of global trade and energy, and expressed opposition to the forced displacement of Palestinians; finance ministers issued a separate statement objecting to unilateral tariffs imposed on BRICS members." }
    ]
  },
  quad: {
