...
const ALLIANCES = {
  nato: {
    ...
    events: [
      ...
      { y: 2026, e: "Ankara Summit (July 7–8): the alliance's first summit hosted by Turkey. Per the pre-approved communiqué, all 32 allies affirm an 'ironclad commitment' to Article 5 collective defence. Members pledge €70 billion in military assistance to Ukraine for 2026 with 'at least equivalent levels' committed for 2027. Trump attends and meets separately with President Erdoğan, President Zelensky, and Syrian transitional leader Ahmad al-Sharaa — signalling sustained US commitment to the alliance despite earlier tensions over Iran and Greenland." }
    ]
  },
  eu: {
