...
const ALLIANCES = {
  nato: {
    ...
    events: [
      ...
      { y: 2026, e: "Ankara Summit (July 7–8): the alliance's second summit hosted by Turkey (after Istanbul 2004). The communiqué has all 32 allies affirm an 'ironclad commitment' to Article 5 collective defence and formally designate Russia as a threat to Euro-Atlantic security. European allies and Canada pledge €70 billion annually in military assistance to Ukraine for both 2026 and 2027 (€140 billion total). Trump attends and meets separately with President Erdoğan, President Zelensky, and Syrian transitional leader Ahmad al-Sharaa — signalling sustained US commitment to the alliance despite earlier tensions over Iran and Greenland." }
    ]
  },
  eu: {
