...
const ECON_DATA = {
  ...
  364: { name:"Iran", gdp:720, gdpPerCap:8000, growth:-6.1, debt:31.0, tradeBalance:26,
    ...
    sanctions:true,
    summary:"Economy under dual shock: Western sanctions and an active war with the US and Israel (Operation Epic Fury, since Feb 28, 2026). IMF April 2026 WEO cut Iran's 2026 growth to -6.1% (a -7.2pp revision). The IRGC closed the Strait of Hormuz, sending oil to $126/barrel; commercial shipping dropped 90%+. Pakistan-mediated Islamabad ceasefire talks collapsed April 12 (JD Vance departed with no deal); Trump declared a US Navy blockade of Hormuz effective April 13. Iran's oil exports are now effectively zero. Mojtaba Khamenei (elected Supreme Leader March 8) is an IRGC-aligned hardliner; any diplomatic reform is suspended." },
  ...
  100: { name:"Bulgaria", gdp:115, gdpPerCap:17200, growth:2.5, debt:26.5, tradeBalance:-7,
    ...
    sanctions:false,
    summary:"Bulgaria is the EU's poorest member by GDP per capita but has very low public debt and hosts significant nearshoring investment due to competitive labour costs. Political instability — multiple elections and caretaker governments since 2021 — has delayed EU policy implementation. Bulgaria joined the Schengen area in 2024 and is working toward eurozone entry." },
